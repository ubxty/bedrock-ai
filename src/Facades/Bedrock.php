 ...
 * @method static \Ubxty\BedrockAi\Client\BedrockClient converseClient(?string $connection = null)
 ...
 * @method static \Ubxty\BedrockAi\Client\BedrockClient streamingClient(?string $connection = null)
